...
export const services: Service[] = [
  ...
  },
  {
    ...
    fromLabel: "¥199 起",
    summary:
      "适合 SCI、SSCI、Scopus、EI、PubMed 等正式投稿稿件，按 author guidelines 完整排版。",
    audience: "author",
    icon: "submit",
    suitableFor: [
      "准备正式投稿期刊的作者",
  ...
  },
  {
    ...
    price: "¥300–1000 / 篇",
    fromLabel: "¥300 起",
    summary: "面向期刊录用后 PDF production 阶段，按期刊固定模板生成正式文章版面。",
  ...
  },
  {
    ...
    price: "按项目报价",
    fromLabel: "按项目报价",
    summary: "面向杂志社、会议、special issue 与论文集，建立统一模板批量排版。",
    audience: "institution",
    icon: "batch",
    suitableFor: [
      "杂志社",
...
export const homeServiceOverview = [
  ...
  },
  {
    id: "batch",
    title: "期刊 / 会议批量排版",
    desc: "适合杂志社、会议、special issue、论文集和编辑部。",
    price: "按项目报价",
